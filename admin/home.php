...
if (mysqli_num_rows($result) <= 0) {
    ...
    <div class="col s12 m5">
      <div class="card-panel red z-depth-0" >
        ...
        <br>
        <span class="white-text">CUST ID : FITL' . $row["uid"] . '
        </span>
        <br>
        ...
        <input type="submit" class="sub waves-effect  white btn btn-success" style="" name="complete" value="COMPLETE">
<input type="submit"  class="sub waves-effect  white btn btn-success" name="cancel" value="CANCEL">
