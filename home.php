...
<!--[if gte IE 9]><!--><html><!--<![endif]-->
      ...
      <ul id="slide-out" class="sidenav">
        <li>
          <div class="user-view">
            ...
            /></a>
            <a href="#name"
              ><span class="white-text name"><?php echo $name ?></span></a
            >
            <a href="#email"
              ><span class="white-text email"
                ><?php echo "FIT" . $id ?></span
              ></a
            >
          </div>
        </li>
      ...
      <div class="col s6 m6">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <p>Cost (0.5 Litre)- ₹<?php echo $co05 ?></p>
  ...
  <div data-keyboard="false" data-backdrop="static" id="modal1" class="modal">
    <div class="modal-content">
      <h5>Groundnut Oil</h5>
      <div class="row">
        <form class="col s12" id="myform1" method="post" action="calculateOrder.php">
          <div class="row">
  ...
  <div id="modal2" class="modal">
    <div class="modal-content">
      <h5>Sesame Oil</h5>
      <div class="row">
        <form class="col s12" id="myform2" method="post" action="calculateOrder.php">
          <div class="row">
            <div class="input-field col s12">
              <p>Quantity :</p>
              <p>
  ...
  <div id="modal3" class="modal">
    <div class="modal-content">
      <h5>Coconut Oil</h5>
      <div class="row">
        <form class="col s12" id="myform3" method="post" action="calculateOrder.php">
          <div class="row">
            <div class="input-field col s12">
              <p>Quantity :</p>
              <p>
  ...
  <div id="modal4" class="modal">
    <div class="modal-content">
      <h5>Castor Oil</h5>
      <div class="row">
        <form class="col s12" id="myform4" method="post" action="calculateOrder.php">
          <div class="row">
            <div class="input-field col s12">
              <p>Quantity :</p>
              <p>
